...
import com.ismailkurt.myapplication.Model.Data;
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(balance>0.05*totalsumincome && balance<=0.1*totalsumincome){
                    ...
                    builder.setTitle("Bakiyen %10'un altında!");
                    builder.setMessage("Giderlerini kontrol et.");
                ...
                {androidx.appcompat.app.AlertDialog.Builder builder=new androidx.appcompat.app.AlertDialog.Builder(getActivity());
                    builder.setTitle("Bakiyen %5'in altında!");
                    builder.setMessage("Giderlerini kontrol et.");
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(amount)){
                    edtAmount.setError("Doldurun..");
                    return;
                }
                int ouramountint=Integer.parseInt(amount);
                if(TextUtils.isEmpty(type)){
                    edtType.setError("Doldurun..");
                    return;
                }
                if(TextUtils.isEmpty(note)){
                    edtNote.setError("Doldurun..");
                    return;
                }
                ...
                if(mAuth.getCurrentUser()!=null) {
                    ...
                    Toast.makeText(getActivity(),"Veri Eklendi",Toast.LENGTH_SHORT).show();
                }
